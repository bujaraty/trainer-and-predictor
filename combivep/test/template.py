...
class SafeGeneralTester(template.SafeTester):
    """ General template for "utils" testing """


    def __init__(self, test_name):
        template.SafeTester.__init__(self, test_name)
...
class RiskyGeneralTester(template.RiskyTester):
    """ General template for "utils" testing """


    def __init__(self, test_name):
        template.RiskyTester.__init__(self, test_name)
